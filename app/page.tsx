...
import { evidence, getPRReport } from "@/lib/memory";
...
export default async function LandingPage() {
  const report = await getPRReport("pr-1");
  const mainSettings = report?.evidence?.main?.settings ?? "screenshots/main/settings.png";
  const prSettings = report?.evidence?.pr?.settings ?? "prs/pr-1/screenshots/settings.png";
      ...
      <div className="fx-content">
        ...
        >
          ...
          <nav style={{ display: "flex", gap: 6, marginLeft: 18 }}>
            <a
              href="#how"
              style={{ color: "var(--muted-3)", fontSize: 14, fontWeight: 500, padding: "7px 12px", borderRadius: 8 }}
            >
              How it works
            </a>
            <a
        ...
        >
          <div style={{ minWidth: 0 }}>
            ...
            >
              Reviews every PR like your most&nbsp;
              <span style={{ color: "var(--accent-2)" }}>paranoid</span> QA engineer.
            </h1>
            <p
              style={{
                color: "var(--muted)",
          ...
          <div>
            <div
              style={{
                position: "relative",
                background: "linear-gradient(180deg,#13151c,#101219)",
                border: "1px solid var(--line-frame)",
                borderRadius: 18,
                padding: 14,
                boxShadow: "0 30px 70px rgba(0,0,0,.55), inset 0 1px 0 rgba(255,255,255,.04)",
              }}
            >
              ...
              {/* current frame */}
              <ScreenShot
                src={evidence(prSettings)}
                url="sample-app/index.html"
                height={218}
                scan
              ...
              <div style={{ display: "flex", alignItems: "center", gap: 8, margin: "13px 2px 4px" }}>
                ...
                <span style={{ fontSize: 13, color: "var(--ink-2)" }}>Clicked “⚙ Settings” → a modal opened</span>
              </div>
              {/* mismatch callout */}
              <div
                style={{
              ...
              >
                ...
                <div style={{ fontSize: 12.5, lineHeight: 1.45, color: "#d6b4b4" }}>
                  Baseline expects <b style={{ color: "#eadada" }}>navigation → /settings.html</b>. This PR opened a{" "}
                  <b style={{ color: "#eadada" }}>modal</b> — and never mentioned Settings.
                </div>
              </div>
            </div>
          </div>
          ...
          >
            <div style={{ padding: "18px 22px", borderRight: "1px solid var(--line)" }}>
              ...
              <div style={{ fontSize: 14, color: "var(--muted)", marginTop: 5 }}>
                Clicks, types and scrolls like a person — no selectors to maintain.
              </div>
            </div>
            <div style={{ padding: "18px 22px", borderRight: "1px solid var(--line)" }}>
              <div style={{ fontFamily: "var(--mono)", fontSize: 12, color: "var(--green)" }}>REPLAYS FROM CACHE</div>
              <div style={{ fontSize: 14, color: "var(--muted)", marginTop: 5 }}>
                Explores once with Computer Use, then replays the route in milliseconds — 0 model calls.
              </div>
            </div>
            <div style={{ padding: "18px 22px" }}>
              <div style={{ fontFamily: "var(--mono)", fontSize: 12, color: "var(--amber)" }}>REVIEWS ON EVERY PUSH</div>
              <div style={{ fontSize: 14, color: "var(--muted)", marginTop: 5 }}>
                A verdict and visual evidence on every pull request, automatically.
              </div>
            </div>
          </div>
        </section>
            ...
            {[
              {
                ...
                c: "var(--accent-2)",
                t: "Learn",
                b: "It explores your app like a new hire — capturing every screen and what each action is supposed to do.",
              },
              {
                n: "02",
                c: "var(--accent-2)",
                t: "Review",
                b: "On every PR it re-drives those flows in a real browser and compares against the accepted baseline.",
              },
              {
                n: "03",
                c: "var(--amber)",
                t: "Catch",
                b: "It reasons about the PR’s stated scope and flags anything that changed but was never declared.",
              },
              {
                n: "04",
                c: "var(--green)",
                t: "Merge",
                b: "Approve, and the new behavior becomes the baseline. Skills graduate. The agent compounds.",
              },
            ].map((s) => (
              <div
                key={s.n}
        ...
        <section id="proof" style={{ maxWidth: 1200, margin: "90px auto 0", padding: "0 28px" }}>
          <div
            style={{
              background: "linear-gradient(180deg, rgba(248,113,113,.06), transparent 40%), #101219",
              border: "1px solid var(--line-frame)",
              borderRadius: 22,
              padding: 34,
          ...
          >
            <div style={{ display: "flex", alignItems: "flex-end", gap: 16, flexWrap: "wrap" }}>
              <div style={{ flex: 1, minWidth: 260 }}>
                ...
                >
                  A one-line copy change that quietly broke navigation.
                </h2>
                <p style={{ color: "var(--muted)", fontSize: 16, lineHeight: 1.55, margin: "14px 0 0", maxWidth: "42em" }}>
                  PR #1 said <i>“update billing copy.”</i> The copy did change. But the same push also turned the
                  Dashboard’s Settings button from a page navigation into a modal — undeclared, in a file nobody flagged.
                  Code review missed it. auto·qa didn’t.
                </p>
              </div>
              <div
                style={{
              ...
              >
                ...
                <div style={{ fontSize: 12.5, color: "#d6b4b4", lineHeight: 1.4 }}>
                  undeclared
                  <br />
                  regression
                </div>
            ...
            <div style={{ display: "grid", gridTemplateColumns: "minmax(0,1fr) minmax(0,1fr)", gap: 18, marginTop: 26 }}>
              <div>
                ...
                >
                  main baseline · click Settings
                </div>
                <ScreenShot src={evidence(mainSettings)} url="sample-app/settings.html" height={230} />
                <div
                  style={{
                    display: "inline-flex",
                    alignItems: "center",
              ...
              <div>
                ...
                >
                  this PR · click Settings
                </div>
                <ScreenShot
                  src={evidence(prSettings)}
                  url="sample-app/index.html"
                  height={230}
                  outline="2px solid rgba(248,113,113,.4)"
                />
                <div
                  style={{
                    display: "inline-flex",
          ...
          <div style={{ textAlign: "center" }}>
            ...
            <div style={{ display: "flex", justifyContent: "center", marginTop: 28 }}>
              <Link
                ...
                style={{ fontSize: 16, padding: "15px 26px", borderRadius: 13, gap: 10 }}
              >
