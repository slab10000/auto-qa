...
export default async function HistoryPage() {
  ...
  return (
    <div>
      <h2
        className="display"
        style={{ fontWeight: 700, fontSize: 28, letterSpacing: "-.02em", margin: 0 }}
      >
        PR history
      </h2>
      <p
      ...
      >
        Pull requests the agent reviewed and you merged. Each merge folded its accepted behavior into
        the baseline.
      </p>
      ...
      <div style={{ display: "flex", flexDirection: "column", gap: 11, marginTop: 24 }}>
        ...
        >
          ...
          <div style={{ flex: 1, minWidth: 0 }}>
            ...
            >
              First run — {m.screens} screens, {m.contracts} contract(s), {m.skills} skill(s),{" "}
              {m.routes} cached route(s) written to memory.
            </div>
          </div>
